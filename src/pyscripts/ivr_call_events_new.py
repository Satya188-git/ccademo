...
QueryString = f"""CREATE OR REPLACE VIEW {view_name} AS (
    ...
    FROM (
    	...
    	FROM \"sdge-dcctr-{env}-wus2-ccc-analytics-connect-datalake-link-preprod\".\"contact_record\" as ctr
...
QueryExecutionContext={
        'Database': f"sdge-dcctr-{env}-wus2-ccc-analytics-connect-datalake-views-preprod",
